...
<div class="relative flex flex-col gap-[30px] my-[60px] px-5">
    <h1 class="font-bold text-[30px] leading-[45px] text-center">
        Booking Successful<br>Congratulations!
    </h1>
    ...
    <div class="flex flex-col gap-[14px]">
        <a href="{{ route('home') }}" 
           class="w-full rounded-full p-[14px_20px] text-center font-bold text-white transition-all duration-300"
           ...
           Explore Other Kos
            ...
            <form action="{{ route('check-booking.show') }}" method="POST">
               ...
               <button type="submit" 
    class="w-full rounded-full p-[14px_20px] text-center font-bold bg-white transition-all duration-300"
    style="color: #00A3FF !important; border: 1px solid #00A3FF !important;">
    View My Booking
</button>         
            </form>
        </div>
