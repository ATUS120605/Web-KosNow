...
<div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            ...
            @else
                <div class="flex items-center justify-between">
                    ...
                    <p class="rounded-full p-[6px_12px] font-bold text-xs leading-[18px] text-white" 
                    style="background-color:#6ec8fc !important;">
                    SUCCESSFUL
                    </p>
                </div>
                @endif
    ...
    <div class="fixed bottom-[30px] w-full max-w-[640px] px-5 z-10">
        <a href="#" 
           class="flex w-full justify-center rounded-full p-[14px_20px] font-bold text-white transition-all duration-300 shadow-[0_10px_20px_0_rgba(0,163,255,0.2)]"
