...
<div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
    ...
    <section id="Result" class=" relative flex flex-col gap-4 px-5 mt-5 mb-9">
       ...
       <style>
    /* Cara paling pasti: Pakai CSS manual supaya tidak tergantung Tailwind */
    .card-kos:hover {
...
<a href="" class="card">
    <div class="card-kos flex rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white transition-all duration-300">
        <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
            <img src="{{ asset('storage/' . $boardingHouse->thumbnail) }}" class="w-full h-full object-cover" alt="{{ $boardingHouse->name }}">
        </div>
